...
public class Brick {
	/*
	 * September 21, 2009 Author by Tawat Atigarbodee
	 * 
	 * Install this program on to NXT brick and use it with
	 * NXTremoteControl_TA.java
	 * 
	 * To use this program. - Install Lejos 0.8.5 - Include Lejos_nxj library to
	 * the project path - Upload the program using lejosdl.bat (I use Eclipse) -
	 * To exit the program, restart NXT brick (remove battery)
	 * 
	 * NXT setup - Port A for right wheel - Port C for left wheel - No sensor is
	 * needed
	 * 
	 * Note: This program is a partial of my project file. I use “USBSend” and
	 * “USBReceive” created by Lawrie Griffiths as a pattern for creating USB
	 * communication between PC and NXT.
	 */
	...
	public static boolean[] checkCommand()// check input data
	{
		...
		try {
			...
			if (transmitReceived != -1) 
				System.out.println("received command: " + transmitReceived);
			...
			//System.out.print("IO Exception readInt" + ioe.getMessage());
